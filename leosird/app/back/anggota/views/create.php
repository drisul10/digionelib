...
<div class="box">
    ...
    <form class="needs-validation" action="<?=Url::BACK_ANGGOTA_CREATE_ACTION;?>" method="POST"
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control <?=($is_any_error_npm ? "is-invalid" : ""); ?>"
                        ...
                        value="<?=$this->get($this->model->field_npm);?>" required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" name="<?=$this->model->field_nama_lengkap;?>" id="nama"
                        placeholder="Nama Lengkap" value="<?=$this->get($this->model->field_nama_lengkap);?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" name="<?=$this->model->field_no_hp;?>" id="nohp"
                        placeholder="Nomor HP" value="<?=$this->get($this->model->field_no_hp);?>" required>
                    <div class="invalid-feedback">
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="email" class="form-control" name="<?=$this->model->field_email;?>" id="email"
                        placeholder="Nomor HP" value="<?=$this->get($this->model->field_email);?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-8 mb-3">
                    ...
                    <input type="text" class="form-control" name="<?=$this->model->field_alamat;?>" id="alamat"
                        placeholder="Alamat" value="<?=$this->get($this->model->field_alamat);?>" required>
                    <div class="invalid-feedback">
