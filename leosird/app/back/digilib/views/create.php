...
<div class="box">
    ...
    <form class="needs-validation" action="<?=Url::BACK_DIGILIB_CREATE_ACTION;?>" method="POST"
        enctype="multipart/form-data" novalidate>
        <div class="box-body">
            <?php if (isset($_GET["error_" . Lang::ERR_CODE_INSERT_TO_DB])) : ?>
            <div class="form-row">
                <div class="col-md-12 alert alert-danger text-center" role="alert">
                    <?= Lang::ERR_MESSAGE_INSERT_TO_DB; ?>
                </div>
            </div>
            <?php endif ?>
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control <?=($is_any_error_kode ? "is-invalid" : ""); ?>"
                        ...
                        value="<?=$this->get($this->model->field_kode);?>" required>
                ...
                <div class="col-md-8 mb-3">
                    ...
                    <input type="text" class="form-control" name="<?=$this->model->field_judul;?>" id="judul"
                        placeholder="Judul Buku" value="<?=$this->get($this->model->field_judul);?>" required>
                    <div class="invalid-feedback">
            ...
            <div class="form-row">
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control" name="<?=$this->model->field_deskripsi;?>" id="deskripsi" rows="3" required><?=$this->get($this->model->field_deskripsi);?></textarea>
                    <div class="invalid-feedback">
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" name="<?=$this->model->field_pengarang;?>" id="pengarang"
                        placeholder="Pengarang Buku" value="<?=$this->get($this->model->field_pengarang);?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" name="<?=$this->model->field_penerbit;?>" id="penerbit"
                        placeholder="Penerbit Buku" value="<?=$this->get($this->model->field_penerbit);?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" type="number" min="1900" max="2099" step="1" class="form-control"
                        ...
                        value="<?=$this->get($this->model->field_tahun);?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="custom-select custom-select-lg mb-3" id="kategori"
                        ...
                        <option value="<?=$value[$model_book_ctg->field_id];?>"
                            <?=($this->get($this->model->field_kategori) == $value[$model_book_ctg->field_id] ? "selected=selected" : "");?>>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="custom-file">
                        <input type="file"
                            ...
                            id="file" name="<?=$this->model->field_file_name;?>" required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="custom-file">
                        <input type="file"
                            ...
                            id="cover" name="<?=$this->model->field_cover_name;?>" required>
        ...
        <div class="box-footer">
            ...
            <button type="submit" name="process" class="btn btn-primary pull-right">Tambah</button>
        </div>
    </form>
</div>
