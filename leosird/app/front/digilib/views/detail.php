...
<div class="col-lg-2">
    ...
    <div class="row">
        <a class="<?=($value[$model_book_ctg->field_id] === $this->get($model_book_ctg->field_id) ? 'text-black' : '');?>"
            href="<?=Url::FRONT_DIGILIB_CATEGORY . "&" . $this->model->field_id . "=" . $value[$model_book_ctg->field_id];?>"><?=$value[$model_book_ctg->field_nama];?></a>
    </div>
    <?php endforeach;?>
</div>
<div class="col-lg-10">
    <div class="box">
                ...
                <div class="col-md-8 mb-3">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <a type="button" class="btn btn-info" target="_blank"
                            href="<?=Url::FRONT_DIGILIB_READ_PDF . "&" . $this->model->field_file_name . "=" . $data[$this->model->field_file_name]?>">
                            Lihat PDF
                        </a>
                    </div>
                </div>
        ...
        <div class="box-footer">
            <button type="button" onclick="window.location.href='<?=Url::FRONT_DIGILIB_INDEX?>'"
