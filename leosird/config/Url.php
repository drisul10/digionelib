...
class Url {
    ...
    {
        return self::base_project() . '/header.php';
    }

    public static function template_back_footer()
    {
        return self::base_project() . '/footer.php';
    }

    public static function template_front_header()
    {
        return self::base_project() . '/header_mahasiswa.php';
    }

    public static function template_front_footer()
    {
        return self::base_project() . '/footer_mahasiswa.php';
    }
}