<div class="box box-success">
    <div class="box-header with-border">
        <h3 class="box-title">Data Digital Library</h3>
    </div>
                ...
                <table class="table " id="mytable">
                    ...
                    <tbody>
                        <?php
                            ...
                            $db= new database();
                            $x=1;
                            foreach ($db->getDataDigitalLibrary() as $key => $value) {
                        ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="#" class="btn btn-sm btn-default"><i class="fa fa-download"></i></a>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $(\'#mytable tbody\').on( \'click\', \'button\', function () {
                    ...
                    $.ajax({
                        url : "'.$base_url.'api.php?get=getDetailDigitalLibrary&id="+data[0],
                        type: "GET",
