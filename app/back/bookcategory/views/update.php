...
<div class="box">
    ...
    <form class="needs-validation" action="<?=Url::BACK_BOOK_CATEGORY_UPDATE_ACTION?>" method="POST">
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" name="<?= $this->model->field_nama; ?>" id="nama"
                        placeholder="Nama Kategori Buku" value="<?= $data[$this->model->field_nama]; ?>" required>
        ...
        <div class="box-footer">
            ...
            <button type="submit" name="process" class="btn btn-info pull-right">Simpan</button>
        </div>
    </form>
</div>
