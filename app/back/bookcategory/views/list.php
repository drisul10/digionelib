...
<div class="row">
    <div class="col-xs-2">
        <a href="<?=Url::BACK_BOOK_CATEGORY_CREATE;?>&b4=" class="btn btn-block btn-social btn-dropbox">
    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-body table-responsive">
                ...
                <table id="tableBookCtg" class="table table-striped table-bordered table-sm">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Nama Kategori</th>
                        ...
                        <tr>
                            ...
                            <td class="td-action">
                                <button type="button" class="btn btn-info btn-sm"
                                    onclick="window.location.href='<?=Url::BACK_BOOK_CATEGORY_UPDATE?>&b4=&<?= $this->model->field_id; ?>=<?= $value[$this->model->field_id]; ?>'">
                                    <span class="glyphicon glyphicon-edit"></span>&nbsp;
                                </button>
                                <button type="button" class="btn btn-danger btn-sm delete-row" data-toggle="modal"
...
<script>
window.history.replaceState({}, document.title, "<?=Url::BACK_BOOK_CATEGORY_INDEX?>");
...
$(document).on("click", "#tableBookCtg .delete-row", function() {
    var ctgBookId = $(this).data('id');

    $(document).on("click", ".action-delete-row", function() {
        window.location.href = '<?=Url::BACK_BOOK_CATEGORY_DELETE . "&" . $this->model->field_id; ?>=' + ctgBookId;
    });
});
</script>